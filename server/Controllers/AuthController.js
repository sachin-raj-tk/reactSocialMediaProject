    ...
    try {
        ...
        if(!userId || !otp){
            ...
            if(userOTPVerificationRecords.length <= 0){
                //no records found
                throw new Error("Account record doesn't exist or have been verified already, Please signup or login");
            }else{
                ...
                if(expiresAt < Date.now()){
                    ...
                    if(!validOTP){
                        ...
                        await UserModel.findOneAndUpdate({_id:userId},{$set:{verified:true}})
